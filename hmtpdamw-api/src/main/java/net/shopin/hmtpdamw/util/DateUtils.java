...
public class DateUtils {
	...
	public static final long PER_HOUR = 60 * PER_MINUTE;
	public static final long PER_DAY = 24 * PER_HOUR;
	...
	public static String formatDate2Str(Date date) {
		return formatDate2Str(date, DATE_TIME_PATTERN_1);
	}
	...
	public static String formatDefault2Define(String dateStr,String defineFormat) {
		return formatSource2Target(dateStr, DATE_TIME_PATTERN_1, defineFormat);
	}
	...
	public static SimpleDateFormat getSimpleDateFormat(String format) {
		...
		if (format == null) {
			sdf = new SimpleDateFormat(DATE_TIME_PATTERN_1);
		} else {
	...
	public static int caculate2Days(Calendar firstCalendar,
		...
		return Math.abs((int) ((calendarNum1 - calendarNum2) / PER_DAY));
	}
    ...
    public static String PrintTimeGap(String str,Date start,Date end){
    	...
    	return PrintTimeGap(str, diffTime);
   }
    //打印两个时间差   -- 用于简单性能测试
   public static String PrintTimeGap(String str,long diffTime){
       ...
       long n=(diffTime -day*24*60*60*1000-hour*60*60*1000-min*60*1000-s*1000);
       return str+ "cost times:"+day+"天"+hour+"小时"+min+"分"+s+"秒"+n+"毫秒 ";
   }
   ...
   public static String getDayBeginTime(){
	   Calendar calendar = Calendar.getInstance();
	    ...
	    return formatDate2Str(start,DATE_TIME_PATTERN_1);
   }
   ...
   public static String getDayEndTime(){
	   Calendar calendar = Calendar.getInstance();
	    ...
	    return formatDate2Str(end,DATE_TIME_PATTERN_1);
